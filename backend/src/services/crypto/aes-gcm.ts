...
export function encryptAES256GCM(
  ...
  try {
    ...
    logger.debug('AES-256-GCM encryption successful', {
...
export function decryptAES256GCM(
  ...
  try {
    ...
    logger.debug('AES-256-GCM decryption successful', {
 ...
 */
export function validateAES256GCMParameters(
  key: Buffer,
  nonce: Buffer,
  tag: Buffer
): void {
...
/**
 * Get AES-256-GCM algorithm parameters
 */
export function getAES256GCMParameters(): {
  algorithm: string;
  keyLength: number;
  nonceLength: number;
  tagLength: number;
